...
export const MenuCard: React.FC<MenuButtonCardProps> = ({
  ...
  return (
    <View className="bg-white rounded-[12px] px-6 py-8 flex-row items-center shadow-md elevation-3 gap-3">
      ...
      {route ? (
        <TouchableOpacity
          ...
          className="p-4 bg-[#E5EDCF] rounded-[8px] justify-center items-center"
        >
          <Image
        ...
        <View className="p-4 bg-[#E5EDCF] rounded-[8px] justify-center items-center">
          <Image
            source={require("@/assets/images/openarrow-icon.png")}
            className="w-4 h-4"
            style={{ tintColor: "#86975A" }}
