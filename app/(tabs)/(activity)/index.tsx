    ...
    switch (step) {
      case 1:
        return {
          title: "Plant Care Activity",
          tutorialDesc:
            "Track every action taken to nurture your plants — watering, lighting, and nutrient updates in one view.",
      ...
      case 2:
        return {
          title: "Harvest Activity",
          tutorialDesc:
            "Track every harvesting task and record your plants' yields in one organized view.",
      ...
      case 3:
        return {
          title: "Planting Activity",
          tutorialDesc:
            "Track all plant updates and interactions — growth, care actions, and status changes in one view.",
      ...
      case 4:
        return {
          title: "Rack Activity",
          tutorialDesc:
            "Track all rack updates and interactions — growth, care actions, and status changes in one view.",
